 ...
 **/
public class MyFIleListAdapter extends BaseQuickAdapter<TrainDetailResponse.DataBean.FilesBean,BaseViewHolder>{
    public MyFIleListAdapter(int layoutResId, @Nullable List<TrainDetailResponse.DataBean.FilesBean> data) {
        super(layoutResId, data);
    }

    public interface OnPreviewTvClickListener{
        void onPreviewTvClick(View v, int adapterPosition, TrainDetailResponse.DataBean.FilesBean item);
    }
    ...
    @Override
    protected void convert(BaseViewHolder helper, TrainDetailResponse.DataBean.FilesBean item) {
