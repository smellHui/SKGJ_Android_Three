...
import com.tepia.main.view.main.question.problemlist.AdapterProblemList;
 ...
 **/
@Route(path = AppRoutePath.app_up_question_list)
public class ProblemCallListActivity extends MVPBaseActivity<QuestionContract.View, QuestionPresenter> implements QuestionContract.View<ProblemCallListBean> {

    public static String key_call = "key_call";
    public static boolean has_success_call = false;
    ...
    private String reservoirName = "",problemCofirmType = "",problemStatus = "",problemSource = "",startDate = "",endDate = "";
    ...
    private void initListView() {
        ...
        adapterPatrolLoggerList = new AdapterProblemCallList(getContext(), R.layout.lv_task_list_item_problemcall_list, dataList,0);
...
//            bundle.putString(key_call, dataList.get(position).getProblemId());
            bundle.putSerializable(key_call,dataList.get(position));
        ...
        adapterPatrolLoggerList.setOnLoadMoreListener(() -> {
            baseinfoRecV.postDelayed(() -> {
                ...
                mPresenter.getProblemCallList(reservoirName, problemCofirmType, problemStatus, problemSource,startDate,endDate, String.valueOf(currentPage), String.valueOf(pageSize), false);
    ...
    private void search(boolean isshowloadiing) {
        ...
        isloadmore = false;
        if (mPresenter != null) {
            mPresenter.getProblemCallList(reservoirName, problemCofirmType, problemStatus, problemSource,startDate,endDate, String.valueOf(currentPage), String.valueOf(pageSize), isshowloadiing);
