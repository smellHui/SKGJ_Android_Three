...
public class HomeXunChaPresenter extends BasePresenterImpl<HomeXunChaContract.View> implements HomeXunChaContract.Presenter{
     ...
     * 查询APP首页数据
     */
    public void getAppHomeGetReservoirInfo() {
        UserManager.getInstance_ADMIN().getAppHomeGetReservoirInfo().safeSubscribe(new LoadingSubject<HomeGetReservoirInfoResponse>(true, ResUtils.getString(R.string.data_loading)) {
            @Override
